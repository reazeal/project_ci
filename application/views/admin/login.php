...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<?php echo site_url('assets/bootstrap/admin/bootstrap/css/bootstrap.min.css');?>">
  <!-- Font Awesome -->
...
<!-- Bootstrap 3.3.6 -->
<script src="<?php echo site_url('assets/bootstrap/admin/bootstrap/css/bootstrap.min.js');?>"></script>
<!-- iCheck -->
